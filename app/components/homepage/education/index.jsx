      ...
      <div className="py-8">
        <div className="flex justify-center items-start">
            <div className="h-[80%] w-[80%] max-w-lg">
              <AnimationLottie height animationPath={lottieFile} />
            </div>
          </div>
                ...
                <div key={education.id} className={`relative flex items-center ${
                  ...
                  <div className={`w-full lg:w-5/12 ${
                    ...
                    <GlowCard identifier={`education-${education.id}`}>
                      <div className="p-2 sm:p-3 relative text-white">
                        <Image
                          src="/blur-23.svg"
                          alt="Hero"
                          width={1080}
                        ...
                        <div className="flex items-center gap-x-4 sm:gap-x-8 px-2 sm:px-3 py-3 sm:py-5">
                          ...
                          <div>
                            ...
                            <p className="text-xs sm:text-sm lg:text-base">{education.institution}</p>
                          </div>
                        </div>
                      </div>
                    </GlowCard>
